...
credentials_sidebar()
st.title("Add Metadata")
st.caption("Add DC and ICAEW metadata to Preservica assets from a CSV (`c_add_metadata_from_csv.py`)")
st.info("The CSV must have an `assetId` column. Metadata columns should be prefixed with `dc:` or `icaew:`.")
...
if st.button("Run", type="primary"):
    ...
    returncode, _ = run_script("add_metadata", ["--csv-file", csv_path])
